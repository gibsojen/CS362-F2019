...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    switch( card )
    {
    // START Assignment 2 effect refactor.
    case ambassador: ambassadorEffect(choice1, choice2, handPos, state, currentPlayer);
    case baron: baronEffect(choice1, state, currentPlayer);
    case mine: mineEffect(choice1, choice2, handPos, state, currentPlayer);
    case minion: minionEffect(choice1, choice2, handPos, state, currentPlayer);
    case tribute: tributeEffect(state, currentPlayer);
    // END Assignment 2 effect refactor.
